...
# =====================================================
# 5. Example Run with Rich Markdown Display
# =====================================================
if __name__ == "__main__":
    ...
    console.print("\n[bold green]Final Result for Frontend:[/bold green]")
    console.print(f"Patient ID: [cyan]{result['patient_id']}[/cyan]")
    console.print(f"Prediction: [yellow]{'High Risk' if result['prediction']==1 else 'Low Risk'}[/yellow]")
    console.print(f"Probability: {result['probability']:.4f}\n")

    # Render Gemini explanation with Markdown
    console.print(Markdown(result["gemini_explanation"]))
